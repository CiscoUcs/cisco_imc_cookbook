...
class AdaptorCfgBackup < ManagedObject
    ...
    @@consts = AdaptorCfgBackupConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("AdaptorCfgBackup", "adaptorCfgBackup", "export-config", VersionMeta::VERSION151F, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], ["Get", "Set"]),
        "modular" => MoMeta.new("AdaptorCfgBackup", "adaptorCfgBackup", "export-config", VersionMeta::VERSION2013E, "InputOutput", 0x3ff, [], ["admin", "read-only", "user"], ["Get", "Set"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "AdaptorCfgBackup", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
