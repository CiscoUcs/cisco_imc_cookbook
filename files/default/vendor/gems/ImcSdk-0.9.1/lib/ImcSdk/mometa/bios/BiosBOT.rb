...
class BiosBOT < ManagedObject
    ...
    @@consts = BiosBOTConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("BiosBOT", "biosBOT", "bdgep", VersionMeta::VERSION151F, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"]),
        "modular" => MoMeta.new("BiosBOT", "biosBOT", "bdgep", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "BiosBOT", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
