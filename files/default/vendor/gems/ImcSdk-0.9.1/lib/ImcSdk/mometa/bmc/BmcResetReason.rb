...
class BmcResetReason < ManagedObject
    ...
    @@consts = BmcResetReasonConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "modular" => MoMeta.new("BmcResetReason", "bmcResetReason", "bmc-reset-reason", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "BmcResetReason", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
