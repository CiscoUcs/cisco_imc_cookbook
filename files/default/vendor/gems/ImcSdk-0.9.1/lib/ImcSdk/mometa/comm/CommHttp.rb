...
class CommHttp < ManagedObject
    ...
    @@consts = CommHttpConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("CommHttp", "commHttp", "http-svc", VersionMeta::VERSION151F, "InputOutput", 0xff, [], ["admin", "read-only", "user"], ["Get", "Set"]),
        "modular" => MoMeta.new("CommHttp", "commHttp", "http-svc", VersionMeta::VERSION2013E, "InputOutput", 0xff, [], ["admin", "read-only", "user"], ["Get", "Set"])
    }
    ...
    @@prop_meta = {
        ...
        "port" => MoPropertyMeta.new("port", "port", "uint", VersionMeta::VERSION151F, MoPropertyMeta::READ_WRITE, 0x8, nil, nil, nil, [], ["1-65535"]), 
        ...
        "redirect_state" => MoPropertyMeta.new("redirect_state", "redirectState", "string", VersionMeta::VERSION151F, MoPropertyMeta::READ_WRITE, 0x10, nil, nil, nil, ["Disabled", "Enabled", "disabled", "enabled"], []), 
        "rn" => MoPropertyMeta.new("rn", "rn", "string", VersionMeta::VERSION151F, MoPropertyMeta::READ_WRITE, 0x20, 0, 255, nil, [], []), 
        "session_timeout" => MoPropertyMeta.new("session_timeout", "sessionTimeout", "uint", VersionMeta::VERSION151F, MoPropertyMeta::READ_WRITE, 0x40, nil, nil, nil, [], ["60-10800"]), 
        ...
        "modular" => {
            ...
            "port" => MoPropertyMeta.new("port", "port", "uint", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x8, nil, nil, nil, [], ["1-65535"]), 
            ...
            "redirect_state" => MoPropertyMeta.new("redirect_state", "redirectState", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x10, nil, nil, nil, ["Disabled", "Enabled", "disabled", "enabled"], []), 
            "rn" => MoPropertyMeta.new("rn", "rn", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x20, 0, 255, nil, [], []), 
            "session_timeout" => MoPropertyMeta.new("session_timeout", "sessionTimeout", "uint", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x40, nil, nil, nil, [], ["60-10800"]), 
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "CommHttp", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
