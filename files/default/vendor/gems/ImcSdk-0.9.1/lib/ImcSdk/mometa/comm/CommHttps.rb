...
class CommHttps < ManagedObject
    ...
    @@consts = CommHttpsConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("CommHttps", "commHttps", "https-svc", VersionMeta::VERSION151F, "InputOutput", 0x7f, [], ["admin", "read-only", "user"], ["Get", "Set"]),
        "modular" => MoMeta.new("CommHttps", "commHttps", "https-svc", VersionMeta::VERSION2013E, "InputOutput", 0x7f, [], ["admin", "read-only", "user"], ["Get", "Set"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "CommHttps", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
