...
class CommSvcEp < ManagedObject
    ...
    @@consts = CommSvcEpConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("CommSvcEp", "commSvcEp", "svc-ext", VersionMeta::VERSION151F, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"]),
        "modular" => MoMeta.new("CommSvcEp", "commSvcEp", "svc-ext", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "CommSvcEp", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
