...
class ComputeSharedIOMbPowerStats < ManagedObject
    ...
    @@consts = ComputeSharedIOMbPowerStatsConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "modular" => MoMeta.new("ComputeSharedIOMbPowerStats", "computeSharedIOMbPowerStats", "power-stats", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "ComputeSharedIOMbPowerStats", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
