...
class DownloadClientCertificate < ManagedObject
    ...
    @@consts = DownloadClientCertificateConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("DownloadClientCertificate", "downloadClientCertificate", "kmip-client-cert-download", VersionMeta::VERSION302B, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], [nil]),
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "DownloadClientCertificate", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
