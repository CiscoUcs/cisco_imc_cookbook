...
class DownloadClientPrivateKey < ManagedObject
    ...
    @@consts = DownloadClientPrivateKeyConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("DownloadClientPrivateKey", "downloadClientPrivateKey", "kmip-private-key-download", VersionMeta::VERSION302B, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], [nil]),
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "DownloadClientPrivateKey", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
