...
class EquipmentChassisLocatorLed < ManagedObject
    ...
    @@consts = EquipmentChassisLocatorLedConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "modular" => MoMeta.new("EquipmentChassisLocatorLed", "equipmentChassisLocatorLed", "chassis-locator-led", VersionMeta::VERSION2013E, "InputOutput", 0x1f, [], ["admin", "read-only", "user"], ["Get", "Set"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "EquipmentChassisLocatorLed", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
