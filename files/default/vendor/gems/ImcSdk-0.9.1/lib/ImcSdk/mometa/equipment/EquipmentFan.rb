...
class EquipmentFan < ManagedObject
    ...
    @@consts = EquipmentFanConsts.new()
#    @@naming_props = set([u'id'])

    @@mo_meta = {
        "classic" => MoMeta.new("EquipmentFan", "equipmentFan", "fan-[id]", VersionMeta::VERSION151F, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"]),
        "modular" => MoMeta.new("EquipmentFan", "equipmentFan", "fan-[id]", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    @@prop_meta = {
        ...
        "module" => MoPropertyMeta.new("module", "module", "uint", VersionMeta::VERSION151F, MoPropertyMeta::READ_ONLY, nil, nil, nil, nil, [], ["1-8"]), 
        ...
        "tray" => MoPropertyMeta.new("tray", "tray", "uint", VersionMeta::VERSION151F, MoPropertyMeta::READ_ONLY, nil, nil, nil, nil, [], ["1-8"]), 
        ...
        "modular" => {
            ...
            "module" => MoPropertyMeta.new("module", "module", "uint", VersionMeta::VERSION2013E, MoPropertyMeta::READ_ONLY, nil, nil, nil, nil, [], ["1-8"]), 
            ...
            "tray" => MoPropertyMeta.new("tray", "tray", "uint", VersionMeta::VERSION2013E, MoPropertyMeta::READ_ONLY, nil, nil, nil, nil, [], ["1-8"]), 
    ...
    def initialize(parent_mo_or_dn: nil,id: nil,  **kwargs)
        ...
        super(class_id: "EquipmentFan", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
