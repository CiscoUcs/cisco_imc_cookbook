...
class EquipmentFanModule < ManagedObject
    ...
    @@consts = EquipmentFanModuleConsts.new()
#    @@naming_props = set([u'tray', u'id'])

    @@mo_meta = {
        "classic" => MoMeta.new("EquipmentFanModule", "equipmentFanModule", "fan-module-[tray]-[id]", VersionMeta::VERSION151F, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"]),
        "modular" => MoMeta.new("EquipmentFanModule", "equipmentFanModule", "fan-module-[tray]-[id]", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    @@prop_meta = {
        ...
        "tray" => MoPropertyMeta.new("tray", "tray", "uint", VersionMeta::VERSION151F, MoPropertyMeta::NAMING, nil, nil, nil, nil, [], ["1-1"]), 
        ...
        "modular" => {
            ...
            "tray" => MoPropertyMeta.new("tray", "tray", "uint", VersionMeta::VERSION2013E, MoPropertyMeta::NAMING, nil, nil, nil, nil, [], ["1-1"]), 
    ...
    def initialize(parent_mo_or_dn: nil,tray: nil, id: nil,  **kwargs)
        @dirty_mask = 0
        @tray = tray
        @id = id
        @child_action = nil
        ...
        super(class_id: "EquipmentFanModule", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
