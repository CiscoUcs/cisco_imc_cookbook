...
class ExportClientCertificate < ManagedObject
    ...
    @@consts = ExportClientCertificateConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("ExportClientCertificate", "exportClientCertificate", "kmip-client-cert-export", VersionMeta::VERSION302B, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], [nil]),
    }
    ...
    @@prop_meta = {
        ...
        "export_progress" => MoPropertyMeta.new("export_progress", "exportProgress", "string", VersionMeta::VERSION302B, MoPropertyMeta::READ_ONLY, nil, nil, nil, nil, [], []), 
        "export_status" => MoPropertyMeta.new("export_status", "exportStatus", "string", VersionMeta::VERSION302B, MoPropertyMeta::READ_ONLY, nil, nil, nil, nil, [], []), 
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "ExportClientCertificate", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
