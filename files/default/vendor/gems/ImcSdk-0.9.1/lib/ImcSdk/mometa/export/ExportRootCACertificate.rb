...
class ExportRootCACertificate < ManagedObject
    ...
    @@consts = ExportRootCACertificateConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("ExportRootCACertificate", "exportRootCACertificate", "kmip-ca-cert-export", VersionMeta::VERSION302B, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], [nil]),
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "ExportRootCACertificate", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
