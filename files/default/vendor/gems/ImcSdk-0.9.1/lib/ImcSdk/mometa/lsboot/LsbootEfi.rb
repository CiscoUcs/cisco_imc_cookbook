...
class LsbootEfi < ManagedObject
    ...
    @@consts = LsbootEfiConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("LsbootEfi", "lsbootEfi", "efi-read-only", VersionMeta::VERSION151F, "InputOutput", 0x7f, [], ["admin", "read-only", "user"], ["Add", "Get", "Remove", "Set"]),
        "modular" => MoMeta.new("LsbootEfi", "lsbootEfi", "efi-read-only", VersionMeta::VERSION2013E, "InputOutput", 0x7f, [], ["admin", "read-only", "user"], ["Add", "Get", "Remove", "Set"])
    }
    ...
    @@prop_meta = {
        ...
        "type" => MoPropertyMeta.new("type", "type", "string", VersionMeta::VERSION151F, MoPropertyMeta::READ_WRITE, 0x40, nil, nil, nil, ["efi"], []), 
        },
        ...
        "modular" => {
            ...
            "type" => MoPropertyMeta.new("type", "type", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x40, nil, nil, nil, ["efi"], []), 
        },
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "LsbootEfi", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
