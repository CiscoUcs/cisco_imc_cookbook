...
class LsbootPchStorage < ManagedObject
    ...
    @@consts = LsbootPchStorageConsts.new()
#    @@naming_props = set([u'name'])

    @@mo_meta = {
        "classic" => MoMeta.new("LsbootPchStorage", "lsbootPchStorage", "pchstorage-[name]", VersionMeta::VERSION201A, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ["Add", "Get", "Remove", "Set"]),
        "modular" => MoMeta.new("LsbootPchStorage", "lsbootPchStorage", "pchstorage-[name]", VersionMeta::VERSION2013E, "InputOutput", 0x1ff, [], ["admin", "read-only", "user"], ["Add", "Get", "Remove", "Set"])
    }
    ...
    @@prop_meta = {
        ...
        "type" => MoPropertyMeta.new("type", "type", "string", VersionMeta::VERSION201A, MoPropertyMeta::READ_WRITE, 0x100, nil, nil, nil, ["PCHSTORAGE"], []), 
        },
        ...
        "modular" => {
            ...
            "type" => MoPropertyMeta.new("type", "type", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x100, nil, nil, nil, ["PCHSTORAGE"], []), 
        },
    ...
    def initialize(parent_mo_or_dn: nil,name: nil,  **kwargs)
        ...
        super(class_id: "LsbootPchStorage", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
