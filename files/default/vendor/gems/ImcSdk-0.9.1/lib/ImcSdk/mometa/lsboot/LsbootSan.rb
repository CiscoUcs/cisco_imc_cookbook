...
class LsbootSan < ManagedObject
    ...
    @@consts = LsbootSanConsts.new()
#    @@naming_props = set([u'name'])

    @@mo_meta = {
        "classic" => MoMeta.new("LsbootSan", "lsbootSan", "san-[name]", VersionMeta::VERSION201A, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ["Add", "Get", "Remove", "Set"]),
        "modular" => MoMeta.new("LsbootSan", "lsbootSan", "san-[name]", VersionMeta::VERSION2013E, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ["Add", "Get", "Remove", "Set"])
    }
    ...
    @@prop_meta = {
        ...
        "lun" => MoPropertyMeta.new("lun", "lun", "string", VersionMeta::VERSION201A, MoPropertyMeta::READ_WRITE, 0x4, nil, nil, %q{([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]){0,1}}, [], []), 
        ...
        "slot" => MoPropertyMeta.new("slot", "slot", "string", VersionMeta::VERSION201A, MoPropertyMeta::READ_WRITE, 0x40, nil, nil, %q{([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|MLOM|L1|L2){0,1}}, [], []), 
        ...
        "subtype" => MoPropertyMeta.new("subtype", "subtype", "string", VersionMeta::VERSION201A, MoPropertyMeta::READ_WRITE, 0x200, nil, nil, nil, ["SAN"], []), 
        "type" => MoPropertyMeta.new("type", "type", "string", VersionMeta::VERSION201A, MoPropertyMeta::READ_WRITE, 0x400, nil, nil, nil, ["SAN"], []), 
        },

        "modular" => {
            "child_action" => MoPropertyMeta.new("child_action", "childAction", "string", VersionMeta::VERSION2013E, MoPropertyMeta::INTERNAL, nil, nil, nil, nil, [], []), 
            "dn" => MoPropertyMeta.new("dn", "dn", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x2, 0, 255, nil, [], []), 
            "lun" => MoPropertyMeta.new("lun", "lun", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x4, nil, nil, %q{([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]){0,1}}, [], []), 
            ...
            "slot" => MoPropertyMeta.new("slot", "slot", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x40, nil, nil, %q{([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|MLOM|SIOC1|SIOC2|IOESlot1|IOESlot2){0,1}}, [], []), 
            ...
            "subtype" => MoPropertyMeta.new("subtype", "subtype", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x200, nil, nil, nil, ["SAN"], []), 
            "type" => MoPropertyMeta.new("type", "type", "string", VersionMeta::VERSION2013E, MoPropertyMeta::READ_WRITE, 0x400, nil, nil, nil, ["SAN"], []), 
        },
    ...
    def initialize(parent_mo_or_dn: nil,name: nil,  **kwargs)
        ...
        super(class_id: "LsbootSan", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
