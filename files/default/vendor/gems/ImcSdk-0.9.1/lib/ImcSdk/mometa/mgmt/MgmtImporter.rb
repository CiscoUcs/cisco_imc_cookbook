...
class MgmtImporter < ManagedObject
    ...
    @@consts = MgmtImporterConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("MgmtImporter", "mgmtImporter", "import-config", VersionMeta::VERSION151F, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], [nil]),
        "modular" => MoMeta.new("MgmtImporter", "mgmtImporter", "import-config", VersionMeta::VERSION2013E, "InputOutput", 0xfff, [], ["admin", "read-only", "user"], [nil])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "MgmtImporter", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
