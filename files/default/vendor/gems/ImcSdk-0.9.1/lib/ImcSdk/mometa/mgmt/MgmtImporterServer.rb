...
class MgmtImporterServer < ManagedObject
    ...
    @@consts = MgmtImporterServerConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "modular" => MoMeta.new("MgmtImporterServer", "mgmtImporterServer", "importer-config", VersionMeta::VERSION2013E, "InputOutput", 0x7ff, [], ["admin", "read-only", "user"], ["Get", "Set"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "MgmtImporterServer", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
