...
class ProcessorEnvStats < ManagedObject
    ...
    @@consts = ProcessorEnvStatsConsts.new()
#    @@naming_props = set([])

    @@mo_meta = {
        "classic" => MoMeta.new("ProcessorEnvStats", "processorEnvStats", "env-stats", VersionMeta::VERSION151F, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"]),
        "modular" => MoMeta.new("ProcessorEnvStats", "processorEnvStats", "env-stats", VersionMeta::VERSION2013E, "OutputOnly", 0xf, [], ["admin", "read-only", "user"], ["Get"])
    }
    ...
    def initialize(parent_mo_or_dn: nil,  **kwargs)
        ...
        super(class_id: "ProcessorEnvStats", parent_mo_or_dn: parent_mo_or_dn, **kwargs)
